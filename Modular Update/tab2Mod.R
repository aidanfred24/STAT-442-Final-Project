...
tab2Server <- function(id, metric_options, axis_options, method_options, Decade_Data) {
  ...
  output$timeline <- renderGirafe({
    ...
    girafe(ggobj = p3,
           ...
           height_svg = 6,
           options = list(opts_hover(css = "fill:green;stroke:black;r: 10px; transition: all 0.1s ease;"))) # Add hover
