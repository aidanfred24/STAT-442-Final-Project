...
# Clusters based on just On site totals
toxins_clustered_on_site <- scale(toxins_clean[,c(51:64 )])

# Check for NA values
sum(is.na(toxins_clustered_on_site))

# Check for NaN values
sum(is.nan(toxins_clustered_on_site))

# Check for Inf values
sum(is.infinite(toxins_clustered_on_site))
...
toxins_clustered_off_site <- scale(toxins_clean[,c(66:87 )])
